...
function myfunc($row1,$result)
{
  ...
  while($row = mysqli_fetch_array($result) ){
      ...
      echo '
      <form action="payNremove.php" method ="post">
      <input type="hidden" name="rid" value= '.$row['rid'].' />'.
      "<input  type='submit' class='waves-effect waves-light btn' value ='pay'/>".
      '</form> ' ;
...
echo "<tr> <td><b>tarns id</b></td>  <td><b>purpose</b></td> <td><b>date</b></td>  <td><b>department</b></td> <td><b>amount</b></td>  <td><b>pay</b></td></tr>";
myfunc($row,$result);
echo "</table>";
